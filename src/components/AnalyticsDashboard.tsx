  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-2xl bg-neutral-900/60 border border-neutral-800 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <span className="px-3 py-1.5 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-mono flex items-center gap-1.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Total Runs */}
        <div className="p-5 rounded-2xl bg-neutral-900/50 border border-neutral-800 shadow-xl relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-neutral-400">Total Executions</span>
        ...
        <div className="p-5 rounded-2xl bg-neutral-900/50 border border-neutral-800 shadow-xl relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-neutral-400">Pipeline Success Rate</span>
        ...
        <div className="p-5 rounded-2xl bg-neutral-900/50 border border-neutral-800 shadow-xl relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-neutral-400">Manual Hours Saved</span>
        ...
        <div className="p-5 rounded-2xl bg-neutral-900/50 border border-neutral-800 shadow-xl relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-neutral-400">Labor Cost Saved</span>
            <span className="p-2 rounded-xl bg-purple-500/10 text-purple-400 border border-purple-500/20">
              <DollarSign className="w-4 h-4" />
            </span>
          </div>
          <div className="text-2xl font-extrabold text-cyan-300 mt-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-neutral-800 bg-neutral-950/80 p-6 shadow-2xl space-y-4">
          <div className="flex items-center justify-between border-b border-neutral-800 pb-3">
            <div>
              <h3 className="text-sm font-bold text-white">Daily Execution Volume &amp; Health</h3>
              <p className="text-xs text-neutral-400 mt-0.5">
                Distribution of automated runs processed across Monday.com webhooks (Last 7 Days)
              </p>
            </div>
            <span className="text-xs font-mono text-neutral-400">Total: 3,420 runs/wk</span>
          </div>

          {/* Bar Chart Visualization */}
          <div className="pt-4 flex items-end justify-between gap-3 h-48 border-b border-neutral-800 pb-3">
            {[
              ...
              <div key={d.day} className="flex-1 flex flex-col items-center gap-2 h-full justify-end group">
                <div className="text-[10px] font-mono text-neutral-400 opacity-0 group-hover:opacity-100 transition">
                  {d.runs}
                </div>
                <div
                  className="w-full max-w-[42px] rounded-t-lg bg-gradient-to-t from-emerald-600 via-teal-500 to-cyan-400 hover:brightness-110 transition cursor-pointer relative"
                ...
                <div className="text-xs font-mono text-neutral-400">{d.day}</div>
              </div>
            ))}
          </div>
          ...
          <div className="flex items-center justify-between text-xs text-neutral-400 pt-1">
            <div className="flex items-center gap-4">
              <span className="flex items-center gap-1.5">
                ...
                <span>Successful Runs (99.4%)</span>
              </span>
              <span className="flex items-center gap-1.5">
                <span className="h-2.5 w-2.5 rounded-sm bg-rose-500" />
                <span>Recovered Errors (0.6%)</span>
              </span>
            </div>
            <span className="font-mono text-[11px]">Zero Data Loss Guarantee</span>
          </div>
        </div>

        {/* Breakdown by Workflow Category */}
        <div className="rounded-2xl border border-neutral-800 bg-neutral-950/80 p-6 shadow-2xl space-y-4">
          <div className="border-b border-neutral-800 pb-3">
            <h3 className="text-sm font-bold text-white">Pipeline Workload Share</h3>
            <p className="text-xs text-neutral-400 mt-0.5">Breakdown by operational category</p>
          </div>

          <div className="space-y-4 pt-2">
            <div>
              <div className="flex justify-between text-xs mb-1.5">
                <span className="text-neutral-300 font-medium">Finance &amp; AP (Invoice OCR)</span>
                <span className="text-emerald-400 font-mono font-bold">59.2%</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-xs mb-1.5">
                <span className="text-neutral-300 font-medium">Sales CRM (Lead Intake)</span>
                <span className="text-cyan-400 font-mono font-bold">24.0%</span>
              </div>
              <div className="w-full h-2 rounded-full bg-neutral-900 overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-xs mb-1.5">
                <span className="text-neutral-300 font-medium">Legal &amp; Compliance (NDA/MSA)</span>
                <span className="text-purple-400 font-mono font-bold">16.8%</span>
              </div>
              <div className="w-full h-2 rounded-full bg-neutral-900 overflow-hidden">
          ...
          <div className="pt-4 border-t border-neutral-800/80">
            <div className="p-3 rounded-xl bg-neutral-900/60 border border-neutral-800 text-xs space-y-1.5 text-neutral-300">
      ...
      <div className="rounded-2xl border border-neutral-800 bg-neutral-950/80 p-6 shadow-2xl space-y-4">
          ...
          <div className="flex items-center gap-1 p-1 rounded-xl bg-neutral-900 border border-neutral-800 text-xs">
            <button
              ...
              className={`px-3 py-1 rounded-lg transition ${
                filterType === "all" ? "bg-neutral-800 text-white font-semibold" : "text-neutral-400 hover:text-white"
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1 rounded-lg transition ${
                filterType === "failed" ? "bg-rose-950 text-rose-300 font-semibold" : "text-neutral-400 hover:text-white"
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1 rounded-lg transition ${
                filterType === "success" ? "bg-emerald-950 text-emerald-300 font-semibold" : "text-neutral-400 hover:text-white"
              }`}
            >
        ...
        {/* Retry status alert */}
        {retryStatusText && (
          <div className="p-3 rounded-xl bg-amber-950/60 border border-amber-800/80 text-amber-200 text-xs font-mono flex items-center gap-2 animate-pulse">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="border-b border-neutral-800 text-neutral-500 font-mono text-[11px] uppercase">
                <th className="py-2.5 px-3">Status</th>
                <th className="py-2.5 px-3">Workflow / Trigger</th>
              ...
              {filteredExecutions.length === 0 ? (
                ...
                filteredExecutions.map((exec) => {
                  ...
                  return (
                    <tr
                      key={exec.id}
                      className="hover:bg-neutral-900/40 transition group cursor-pointer"
                      ...
                      <td className="py-3 px-3 max-w-[280px]">
                        {isFailed ? (
                          <div className="space-y-0.5">
                            <div className="text-rose-400 font-semibold truncate text-[11px]">
                              {exec.errorStep || "Node Failure"}
                            </div>
                            <div className="text-neutral-400 text-[10px] font-mono truncate" title={exec.errorMsg || ""}>
                      ...
                      <td className="py-3 px-3 text-right whitespace-nowrap">
                        {isFailed ? (
                          <button
                            ...
                            disabled={isRetrying}
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-500 hover:bg-amber-400 disabled:opacity-50 text-neutral-950 font-bold text-xs shadow-md transition active:scale-95"
                          >
                            <RotateCcw className={`w-3.5 h-3.5 ${isRetrying ? "animate-spin" : ""}`} />
                            <span>{isRetrying ? "Retrying..." : "⚡ Retry with Backoff"}</span>
                          </button>
                        ) : (
                          <span className="text-[11px] text-neutral-500 font-mono">Completed</span>
                        )}
                      </td>
                    </tr>
                  );
        ...
        {selectedFailedExec && (
          <div className="mt-4 p-4 rounded-xl bg-neutral-900 border border-neutral-800 space-y-3 animate-in fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
              <div>
                <span className="text-neutral-500 font-mono text-[10px] block mb-1">INPUT PAYLOAD:</span>
                <pre className="p-2.5 rounded-lg bg-neutral-950 border border-neutral-800 font-mono text-[11px] text-neutral-300 max-h-36 overflow-y-auto">
              ...
              <div>
                ...
                <pre className="p-2.5 rounded-lg bg-neutral-950 border border-neutral-800 font-mono text-[11px] text-rose-300 max-h-36 overflow-y-auto">
            ...
            {selectedFailedExec.status === "FAILED" && (
              <div className="flex justify-end pt-1">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs transition"
                >
