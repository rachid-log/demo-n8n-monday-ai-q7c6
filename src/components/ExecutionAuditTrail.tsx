  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-2xl bg-neutral-900/60 border border-neutral-800 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <div className="p-1 rounded-xl bg-neutral-900 border border-neutral-800 text-xs flex">
            <button
            ...
            <button
              ...
              className={`px-3 py-1 rounded-lg transition ${
                filter === "SUCCESS" ? "bg-emerald-950 text-emerald-300 font-semibold" : "text-neutral-400 hover:text-white"
              }`}
            >
              Success
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-lg transition ${
                filter === "FAILED" ? "bg-rose-950 text-rose-300 font-semibold" : "text-neutral-400 hover:text-white"
              }`}
            >
              Failed
            </button>
      ...
      <div className="space-y-3">
        {filtered.length === 0 ? (
          <div className="p-12 rounded-2xl border border-dashed border-neutral-800 text-center text-neutral-500 text-xs">
          ...
          filtered.map((exec) => {
            ...
            return (
              <div
                key={exec.id}
                className="rounded-2xl border border-neutral-800 bg-neutral-950/80 shadow-xl overflow-hidden transition"
              >
                {/* Accordion Header */}
                <div
                  onClick={() => setExpandedId(isExpanded ? null : exec.id)}
                  className="p-4 flex items-center justify-between cursor-pointer hover:bg-neutral-900/40 transition gap-4"
                >
                ...
                {isExpanded && (
                  <div className="p-4 border-t border-neutral-800 bg-neutral-900/30 space-y-4 text-xs animate-in fade-in">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <pre className="p-3 rounded-xl bg-neutral-950 border border-neutral-800 font-mono text-[11px] text-cyan-300 max-h-48 overflow-y-auto leading-relaxed">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <pre
                          className={`p-3 rounded-xl bg-neutral-950 border border-neutral-800 font-mono text-[11px] max-h-48 overflow-y-auto leading-relaxed ${
